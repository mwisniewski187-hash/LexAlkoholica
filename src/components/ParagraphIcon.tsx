...
/**
 * Perfectly upright, geometrically authentic Polish legal paragraph sign (§).
 * Uses the canonical silcrow vector path (viewBox 0 0 256 512),
 * completely eliminating font metric slant, baseline shifts, and asymmetrical hook distortion.
 */
export const ParagraphIcon: React.FC<ParagraphIconProps> = ({
  className = "w-4 h-4",
  size,
}) => {
  return (
